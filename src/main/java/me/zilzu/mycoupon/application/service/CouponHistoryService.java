...
public class CouponHistoryService {
    ...
    public CouponHistory retrieveCouponHistory(CouponHistoryId historyId) {
        ...
        return new CouponHistory(historyEntity.id, new CouponId(historyEntity.refCouponId), historyEntity.usageTime, historyEntity.couponCurrency, historyEntity.price, historyEntity.discountedPrice);
    }
    ...
    public List<CouponHistory> retrieveCouponHistoryList(CouponId couponId) {
        ...
        return histories
                .stream()
                .map(entity -> new CouponHistory(entity.id, new CouponId(entity.refCouponId), entity.usageTime, entity.couponCurrency, entity.price, entity.discountedPrice))
