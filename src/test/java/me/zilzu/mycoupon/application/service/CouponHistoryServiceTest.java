...
class CouponHistoryServiceTest {
    ...
    void coupon_apply_with_discountPrice() {
        ...
        CouponHistory applyAmount = couponService.apply(coupon01.id, price);
        CouponHistory applyPercent = couponService.apply(coupon02.id, price);
        CouponHistory applyAmountOver = couponService.apply(coupon03.id, price);
        assertThat(applyAmount.discountedPrice).isEqualTo(70L);
        assertThat(applyPercent.discountedPrice).isEqualTo(price * (37.15 / 100));
